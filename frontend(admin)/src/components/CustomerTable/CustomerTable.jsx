...
const CustomerTable = ({ customers, currentPage, setCurrentPage }) => {
  // State for modal
            ...
            {paginatedCustomers.map((customer) => (
              <tr key={customer.id}>
                ...
                <td className="total-spends-cell">
                  ${customer.totalSpends ? customer.totalSpends.toFixed(2) : '0.00'}
                </td>
                <td>
                  <button 
      ...
      <div className="pagination-container">
        ...
        <div className="pagination-numbers">
          {getPageNumbers().map((page, index) => (
            page === '...' ? (
              <span key={`ellipsis-${index}`} className="pagination-dots">...</span>
            ) : (
              <button 
                key={`page-${page}`}
            ...
            <div className="modal-body">
              ...
              <div className="form-group">
                ...
                <input 
                  ...
                  readOnly 
                />
                <small className="form-text text-muted">This value is calculated automatically from orders</small>
              </div>
            </div>
